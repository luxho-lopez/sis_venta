                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="apell_cliente" id="apell_cliente" class="form-control" disabled required>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Colonia</label>
                                <input type="text" name="col_cliente" id="col_cliente" class="form-control" disabled required>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <!-- <br>
                                    <input id="serie" class="form-control" type="text" name="serie" placeholder="Ingresa la serie del producto"> -->
                                </div>
                            </div>
                        </div>
                    </div>
