            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data_producto['descripcion']; ?>" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="cantidad">Agregar Cantidad</label>
                            <!-- <span>Si desea disminuir la cantidad, inserte numeros negativos</span> -->
