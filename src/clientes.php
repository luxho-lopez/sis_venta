...
if (!empty($_POST)) {
    $alert = "";
    if (empty($_POST['nombre']) || empty($_POST['apellido']) || empty($_POST['telefono']) || empty($_POST['direccion']) || empty($_POST['colonia']) || empty($_POST['ciudad'])) {
        ...
        $result = 0;
        $query = mysqli_query($conexion, "SELECT * FROM cliente WHERE nombre = '$nombre' && apellido = '$apellido' && ciudad = '$ciudad'");
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO cliente(nombre,apellido,telefono,direccion,colonia,ciudad,usuario_id) values ('$nombre', '$apellido', '$telefono', '$direccion', '$colonia', '$ciudad', '$usuario_id')");
            if ($query_insert) {
            ...
            <div class="modal-body">
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese Colonia" name="colonia" id="colonia" class="form-control">
                    </div>
                    <div class="form-group">
